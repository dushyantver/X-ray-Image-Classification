...
class ModelPusher:
    ...
    def build_and_push_bento_image(self):
        ...
        try:
            ...
            os.system(
                f"bentoml containerize {self.model_pusher_config.bentoml_service_name}:latest -t 975049896809.dkr.ecr.ap-south-1.amazonaws.com/{self.model_pusher_config.bentoml_ecr_image}:latest"
            )
            ...
            os.system(
                "aws ecr get-login-password --region ap-south-1 | docker login --username AWS --password-stdin 975049896809.dkr.ecr.ap-south-1.amazonaws.com"
            )
            ...
            os.system(
                f"docker push 975049896809.dkr.ecr.ap-south-1.amazonaws.com/{self.model_pusher_config.bentoml_ecr_image}:latest"
            )
